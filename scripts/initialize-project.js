...
packageJSON.scripts['bundle-report'] = `webpack-bundle-analyzer dist/${config.newProjectName}/stats-es2015.json`;
packageJSON.scripts['serve'] = `./node_modules/.bin/static-server dist/${config.newProjectName}`;
